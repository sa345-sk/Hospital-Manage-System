    ...
    return (
        <div className="sidebar w-64 h-screen fixed">
            ...
            <div className="sidebar-title w-full h-14 text-center pt-3 text-2xl ">
                ...
                <div className="w-full p-4 mb-11">
                ...
                <div className="ml-4 text-main mr-3 w-52 p-1" style={{ backgroundColor: 'rgba(203, 213, 225, 0.2)', borderRadius: '5px'}}>© {new Date().getFullYear()} All Rights Reserved.</div>
                </div>
        </div>
    )
}
