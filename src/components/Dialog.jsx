        ...
        <div className="dialog z-40">
            <div className="wrapper shadow">
                ...
                <div className="inputs flex justify-between mt-9 flex-row flex-wrap">
                    ...
                    {showPrice ? <input inputMode="numeric" placeholder="Price (N)" value={price} style={{marginBottom: '5px'}} onChange={(e) => {
                    ...
                    {showInvAmount ? <input type="number" placeholder="Amount (N)" value={invAmount} disabled className="bg-white hover:cursor-not-allowed" inputMode="numeric"/>:null}
